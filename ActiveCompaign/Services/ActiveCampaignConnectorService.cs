...
/// <summary>
/// Summary description for ActiveCampaignConnectorService
/// </summary>
public class ActiveCampaignConnectorService
{
    ...
    public string Request(IReadOnlyDictionary<string, object> response)
    {
        //if (response["result_code"].ToString() == "1")
            return response["result_message"].ToString();
        //throw new ExceptionService(response["result_message"].ToString());
    }
}